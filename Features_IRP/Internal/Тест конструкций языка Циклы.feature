...
Функционал: Тест конструкций языка Циклы
...
//// в текущем релизе конструкция "И для каждой строки таблицы "ItemList" я выполняю" будет выполняться бесконечно, заменила на другую
//	И для каждой строки таблицы "ItemList" я выполняю используя колонку "N"
